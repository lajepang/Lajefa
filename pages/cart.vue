...
import type { Products } from "~/components/types/products";
...
<template>
  <div class="w-[70%] mt-3">
    ...
    <div class="flex justify-between items-center pt-7 w-[30%]" style="border-bottom: 3px solid black;">
      <h4 class="text-3xl font-medium mb-1">Barang Yang Dibeli :</h4>
    </div>
  </div>
  <div class="w-[30%] bg-white shadow-xl h-max p-6 mb-3 mt-4">
